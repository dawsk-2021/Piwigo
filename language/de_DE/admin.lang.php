...
$lang['User %s [%s] was added to the subscription list.'] = 'Benutzer %s [%s] zur Liste der Abonnenten hinzugefügt';
...
$lang['No photos selected, no actions possible.'] = 'Kein Foto ausgewählt, keine Aktion möglich.';
...
$lang['No groups selected, no actions possible.'] = 'Keine Gruppen ausgewählt, Aktion kann nicht durgeführt werden';
...
$lang['No users selected, no actions possible.'] = 'Kein Benutzer ausgewählt, keine Aktion möglich.';
...
$lang['No tags selected, no actions possible.'] = 'Kein TAG gewählt, keine Aktion möglich.';
...
$lang['User associated'] = 'Benutzer verknüpft';
$lang['User "%s" dissociated from this group'] = 'Benutzer "%s" von dieser Gruppe entfernt';
$lang['Videos'] = 'Videos';
$lang['Yes, delete'] = 'Ja, lösche';
$lang['Yes, I am sure'] = 'Ja, ich bin mir sicher.';
$lang['You have %s1 orphan : %s2'] = 'Sie haben %s1 verwaiste : %s2';
$lang['You have %s inactive plugins'] = 'Sie haben %s nicht aktive Plugins.';
$lang['You don\'t have access to this photo'] = 'Sie haben keinen Zugriff auf dieses Foto';
$lang['You have %d orphan tags %s'] = 'Sie haben %d nicht benutzte Schlagwörter: %s';
$lang['%s other tags available..'] = '%s weitere Schlagworte vorhanden...';
$lang['<b>%d</b> albums found'] = '<b>%d</b> Alben gefunden';
$lang['<b>%d</b> tag selected'] = '<b>%d</b> Schlagwort ausgewählt';
$lang['<b>%d</b> tag found'] = '<b>%d</b> Schlagwort gefunden';
$lang['<b>%d</b> tags found'] = '<b>%d</b> Schlagworte gefunden';
$lang['<b>1</b> album found'] = '<b>1</b> Album gefunden';
$lang['%s MB used'] = '%s MB verwendet';
$lang['%s GB used'] = '%s GB verwendet';
$lang['%s file type'] = '%s Dateityp';
$lang['%d photos'] = '%d Fotos';
$lang['%d sub-albums'] = '%d Unteralben';
$lang['%d Activity'] = '%d Aktivität';
$lang['%d Activities'] = '%d Aktivitäten';
$lang[' (copy %s)'] = '(%s kopieren)';
$lang[' (copy)'] = '(kopieren)';
$lang['The other tags will be removed'] = 'Die anderen Schlagwörter werden entfernt';
$lang['This is already the default theme'] = 'Dies ist bereits das Standardthema';
$lang['Unset as group for new users'] = 'Nicht als Gruppe für neue Benutzer festlegen';
$lang['and %s others'] = 'und %s andere';
$lang['in administration'] = 'in der Administration';
$lang['in gallery'] = 'in der Galerie';
$lang['no photo'] = 'kein Foto';
$lang['Refresh thumbnail'] = 'Vorschaubild aktualisieren';
$lang['Requires PHP %s'] = 'Erforderliche PHP-Version %s';
$lang['Review'] = 'Überprüfung';
$lang['Search albums'] = 'Alben suchen';
$lang['Search tips'] = 'Tipps zur Suche';
$lang['Select'] = 'Auswählen';
$lang['Select all %d tags'] = 'Alle %d Schlagwörter auswählen';
$lang['Selection mode'] = 'Auswahlmodus';
$lang['Set as default'] = 'Als Standard einstellen';
$lang['Set as group for new users'] = 'Als Gruppe für neue Benutzer festlegen';
$lang['Show inactive plugins'] = 'Inaktive Plugins anzeigen';
$lang['Showing %s users out of %s'] = 'Zeigt %s Benutzer von %s';
$lang['Storage'] = 'Speicher';
$lang['Tag "%s" created'] = 'Schlagwort "%s" erstellt';
$lang['Tag "%s" succesfully deleted'] = 'Schlagwort \"%s\" erfolgreich gelöscht';
$lang['Tag "%s1" renamed in "%s2"'] = 'Schlagwort \"%s1\" umbenannt in \"%s2\"';
$lang['Tag Manager'] = 'Schlagwort-Manager';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = 'Schlagwort(e) \{%s1\} wurde(n) erfolgreich in "%s2" zusammengeführt';
$lang['Tags \{%s\} succesfully deleted'] = 'Schlagwörter \{%s\} erfolgreich gelöscht';
$lang['The %d tags on this page are selected'] = 'Die Schlagwörter %d auf dieser Seite sind ausgewählt';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Gruppe(n) \{%s1\} erfolgreich in "%s2" zusammengeführt';
$lang['Groups \{%s\} succesfully deleted'] = 'Gruppen \{%s\} erfolgreich gelöscht';
$lang['Keep them'] = 'Behalte diese';
$lang['Manage album photos'] = 'Albumfotos verwalten';
$lang['Manage sub-albums'] = 'Unteralben verwalten';
$lang['Manage users with user manager'] = 'Verwalten von Benutzern mit dem Benutzermanager';
$lang['Merge'] = 'Zusammenführen';
$lang['Name is already taken'] = 'Name wird bereits verwendet';
$lang['No albums found'] = 'Keine Alben gefunden';
$lang['No plugins found'] = 'Keine Plugins gefunden';
$lang['No tag found'] = 'Kein Schlagwort gefunden';
$lang['No, I have changed my mind'] = 'Nein, ich habe meine Meinung geändert';
$lang['Open in gallery'] = 'In Galerie öffnen';
$lang['Other'] = 'Andere';
$lang['Page Visited'] = 'Seite besucht';
$lang['Page Visited in %s'] = 'Seite besucht in %s';
$lang['Please upgrade your PHP version before any update.'] = 'Bitte aktualisieren Sie Ihre PHP-Version vor einem Update.';
$lang['Portraits'] = 'Porträts';
$lang['Posted %s'] = 'Geschrieben %s';
$lang['Promote mobile app on mobile devices'] = 'Mobile App auf mobilen Geräten promoten';
$lang['Average last 12 months'] = 'Durchschnitt der letzten 12 Monate';
$lang['Cache'] = 'Cache';
$lang['Choose which tag to merge these tags into'] = 'Wählen Sie, in welchem Schlagwort diese Schlagwörter zusammengeführt werden sollen';
$lang['Clear Selection'] = 'Auswahl löschen';
$lang['Compare mode'] = 'Vergleichsmodus';
$lang['Created on %s'] = 'Erstellt am %s';
$lang['Delete album'] = 'Album löschen';
$lang['Delete orphan tags ?'] = 'Verwaiste Schlagwörter löschen?';
$lang['Delete tag "%s"?'] = 'Schlagwort "%s" löschen? ';
$lang['Delete tags \{%s\}?'] = 'Schlagwörter löschen \{%s\}?';
$lang['Delete them'] = 'Lösche diese';
$lang['Display'] = 'Anzeige';
$lang['Displays a banner to install or open the official Piwigo app'] = 'Zeigt ein Banner zur Installation oder zum Öffnen der offiziellen Piwigo-App an';
$lang['Dissociate user from this group'] = 'Benutzer aus dieser Gruppe entfernen.';
$lang['Edited on %s'] = 'Bearbeitet am %s';
$lang['File type: %s'] = 'Dateityp: %s';
$lang['Formats'] = 'Formate';
$lang['Group "%s" succesfully deleted'] = 'Gruppe "%s" erfolgreich gelöscht';
$lang['Group added'] = 'Gruppe hinzugefügt';
$lang['Group renamed'] = 'Gruppe umbenannt';
$lang['Activity peak in the last weeks'] = 'Aktivitätsspitze in den letzten Wochen';
$lang['Album search tool'] = 'Album-Suchwerkzeug';
$lang['Are you sure you want to delete all sizes?'] = 'Sind Sie sicher, dass Sie alle Größen löschen wollen?';
$lang['Are you sure you want to delete group "%s"?'] = 'Sind Sie sicher, dass Sie die Gruppe "%s" löschen wollen?';
$lang['Are you sure you want to delete the language "%s"?'] = 'Sind Sie sicher, dass Sie die Sprache "%s" löschen wollen?';
$lang['Are you sure you want to delete the plugin "%s"?'] = 'Sind Sie sicher, dass Sie das Plugin "%s" löschen wollen?';
$lang['Are you sure you want to delete the ratings of the user "%s"?'] = 'Sind Sie sicher, dass Sie die Bewertungen des Benutzers "%s" löschen möchten?';
$lang['Are you sure you want to delete the theme "%s"?'] = 'Sind Sie sicher, dass Sie das Thema "%s" löschen möchten?';
$lang['Are you sure you want to delete the user "%s"?'] = 'Sind Sie sicher, dass Sie den Benutzer "%s" löschen möchten?';
$lang['Are you sure you want to delete this site?'] = 'Sind Sie sicher, dass Sie diese Seite löschen möchten?';
$lang['Are you sure you want to delete this theme?'] = 'Sind Sie sicher, dass Sie dieses Thema löschen möchten?';
$lang['Are you sure you want to delete this?'] = 'Sind Sie sicher, dass Sie dies löschen möchten?';
$lang['Are you sure you want to install the plugin "%s"?'] = 'Sind Sie sicher, dass Sie das Plugin "%s" installieren möchten?';
$lang['Are you sure you want to lock the gallery?'] = 'Sind Sie sicher, dass Sie die Galerie sperren wollen?';
$lang['Are you sure you want to restore the plugin "%s"?'] = 'Sind Sie sicher, dass Sie das Plugin "%s" wiederherstellen wollen?';
$lang['Are you sure you want to restore this plugin?'] = 'Sind Sie sicher, dass Sie dieses Plugin wiederherstellen wollen?';
$lang['Are you sure you want to restore to default settings?'] = 'Sind Sie sicher, dass Sie die Standardeinstellungen wiederherstellen wollen?';
$lang['Are you sure you want to update all extensions?'] = 'Sind Sie sicher, dass Sie alle Erweiterungen aktualisieren möchten?';
$lang['Associate User'] = 'Zugehöriger Benutzer';
$lang['At least 2 selected tags are needed to merge'] = 'Es werden mindestens 2 ausgewählte Tags zum Zusammenführen benötigt';
$lang['<b>%d+</b> albums found, try to refine the search'] = '<b>%d+</b> Alben gefunden, versuchen Sie, die Suche zu verfeinern';
$lang['Add Album'] = 'Album hinzufügen';
$lang['Apply an automatic order to root albums'] = 'Anwenden einer automatischen Reihenfolge auf Stammalben';
$lang['Apply to direct sub-albums'] = 'Auf direkte Unteralben anwenden';
$lang['Apply to the whole hierarchy'] = 'Auf die gesamte Hierarchie anwenden';
$lang['Compact View'] = 'Kompaktansicht';
$lang['Drag and drop to reorder albums'] = 'Ziehen und Ablegen zum Neuordnen von Alben';
$lang['Hide sub-albums'] = 'Unteralben ausblenden';
$lang['Line View'] = 'Linienansicht';
$lang['Name field must not be empty'] = 'Namensfeld darf nicht leer sein';
$lang['Root'] = 'Stamm';
$lang['Select an album... or type it!'] = 'Wählen Sie ein Album aus... oder geben Sie es ein!';
$lang['Show sub-albums'] = 'Unteralben anzeigen';
$lang['Tile View'] = 'Kachelansicht';
