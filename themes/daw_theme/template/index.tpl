<!-- Start of index.tpl -->
{combine_script id='cookie' require='jquery' path='themes/daw_theme/js/jquery.cookie.js' load='footer'}
{combine_script id='equalheights' require='jquery' path='themes/daw_theme/js/jquery.equalheights.js' load='footer'}
