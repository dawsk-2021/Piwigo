                        ...
                        <form action="{$rating.F_ACTION}" method="post" id="rateForm" style="margin:0;">
                            <div>
                                ...
                                {strip}{combine_script id='core.scripts' path='themes/default/js/scripts.js' load='async'}
                                    {combine_script id='rating' require='core.scripts' path='themes/daw_theme/js/rating.js' load='async'}
                                    {footer_script require='jquery'}
                                    ...
                                    'rateButtonStarEmpty');
                                    $(this).removeClass(rating.average > $(this).data('value') - 0.5 ? 'rateButtonStarEmpty' :
                                    'rateButtonStarFull');
                                    {rdelim});
                                    {rdelim}
                                    {rdelim});
